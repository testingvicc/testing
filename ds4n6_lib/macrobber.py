...
def harmonize(df, **kwargs):
    ...
    # TODO: Convert all tstamps that make sense to categorical
    # e.g. df['MTStampDate_'] = pd.Categorical(df['MTStamp_'].dt.date, categories=df['MTStamp_'].dt.date.drop_duplicates())
