...
@pd.api.extensions.register_dataframe_accessor("d4XXXX")
class Ds4n6XXXXAccessor:
...
@pd.api.extensions.register_dataframe_accessor("d4_XXXXXXXX")
class Ds4n6XXXXXXXXAccessor:
    def __init__(self, pandas_obj):
        self._obj = pandas_obj
