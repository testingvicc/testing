...
# TODO: IMPLEMENT OTHER ANALYSIS IDEAS

#    # Pre-pocessing    - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#    # Remove Microsoft Staff
#    df_pre = df[~df['Company'].str.contains("Microsoft Corporation").fillna(False)]
#
#    # DS Analysis  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#    # TODO: SANS Book Outlier analysis - Easy - Entries only in 1 host
#
#    # Real Outlier analysis 
#    #intgdf = df_outlier_analysis(df_pre,2)
#    # TODO: What DS technique would have helped here?
#
#    # 4n6 Analysis - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#    #searchfor = ['.exe', 'powershell','.bat']
#    searchfor = ['powershell']
#    intgdf = df_pre[df_pre['Launch_String'].str.contains('|'.join(searchfor)).fillna(False)]
#    intgdf = intgdf[~df_pre['Signer'].str.contains("(Verified)").fillna(False)]
#
#    intgdf['exe'] = intgdf['Launch_String'].str.contains('\.exe')
#    intgdf['bat'] = intgdf['Launch_String'].str.contains('\.bat')
#    intgdf['powershell'] = intgdf['Launch_String'].str.contains('powershell')
#
#    # Selected Column
#    intgdf['Selected'] = False
#
#    return intgdf
